...
//        Log.d("2222", "f:" + mLastTab.fragment);
        for (TabInfo tabInfo : mTabs) {
//            Log.d("2222", "### " + tabInfo.fragment);
//            if (tabInfo.fragment instanceof BaseFragment) {
////                Log.d("2222", "---->)");
//                BaseFragment baseFragment = (BaseFragment) mLastTab.fragment;
//                baseFragment.onUpdate();
//            }
            if (tabInfo.fragment instanceof CategoryFragment) {
                if (tabInfo.fragment.isVisible()) {
                    CategoryFragment f = (CategoryFragment) mLastTab.fragment;
                   // f.onUpdate();
                }
            }
        }
//        if (mLastTab.fragment instanceof CategoryFragment) {
//            Log.d("2222", "f---cateory");
//            CategoryFragment fragment = (CategoryFragment) mLastTab.fragment;
//            fragment.updateDevices();
//        } else if (mLastTab.fragment instanceof PictureFragment) {
//            Log.d("2222", "f---pictrue");
//            PictureFragment fragment = (PictureFragment) mLastTab.fragment;
//            fragment.upateMedia();
//        }
